...
Partial Class FrmInformeCCxCliente
    ...
    'Friend WithEvents libreria_bigognoDataSetCCxCliente As Gestion_Comercial.libreria_bigognoDataSetCCxCliente
    'Friend WithEvents get_listadoCCxClienteTableAdapter As Gestion_Comercial.libreria_bigognoDataSetCCxClienteTableAdapters.get_listadoCCxClienteTableAdapter
End Class
